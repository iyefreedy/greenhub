      ...
      <div className="flex flex-col rounded-lg border border-neutral-200 bg-white p-8 md:p-12 lg:flex-row lg:gap-8 ">
        ...
        <div className="basis-full lg:basis-2/6">
          <div className="mb-6 flex flex-col border-b pb-6 ">
            ...
            <div className="mr-auto w-auto rounded-full bg-green-600 p-2 text-sm text-white">
          ...
          <button
            ...
            className="relative flex w-full items-center justify-center rounded-full bg-green-600 p-4 tracking-wide text-white"
          >
