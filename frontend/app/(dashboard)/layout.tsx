...
export default async function DashboardLayout({
  ...
  return (
    <div className="h-screen bg-gray-100">
      <nav className="px-4 bg-white mx-auto shadow-sm ">
        <div className="h-20 flex justify-between items-center container">
          ...
          <div className="space-x-4">
            <Link
              href={"/seller"}
              className="px-4 py-1.5 bg-green-400 rounded-full"
            >
              Seller
            </Link>
            ...
            <Menu>
              ...
              <MenuItems
                anchor="bottom end"
                className="p-2 bg-white w-40 shadow-md rounded-md space-y-2"
              >
                <MenuItem>
      ...
      <main className="lg:ml-72 mt-4 px-6">{children}</main>
    </div>
  );
}
